#!/bin/bash
cd /home/madlab/Dropbox-Uploader
...
grep "file exists with the same hash" /home/madlab/charge_controller/upload_output.txt > /home/madlab/charge_controller/already_uploaded.txt
...
done < /home/madlab/charge_controller/already_uploaded.txt

for file in already_uploaded.txt logs_to_upload.txt upload_output.txt; do
  if [ -f "/home/madlab/charge_controller/$file" ]; then
    rm "/home/madlab/charge_controller/$file"
    echo "Deleted $file"
  fi
done
